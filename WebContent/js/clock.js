var lunarInfo = [0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950,
...
var cmStr = ['日', '正', '二', '三', '四', '五', '六', '七', '八', '九', '十',
		'冬', '腊']
...
function solarDay() {
	var sTermInfo = [0, 21208, 42467, 63836, 85337, 107014, 128867,
	...
	var solarTerm = ["小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨",
			...
			"霜降", "立冬", "小雪", "大雪", "冬至"]
	var lFtv = ["0101*春节", "0115 元宵节", "0505 端午节", "0707 七夕",
			"0715 中元节", "0815 中秋节", "0909 重阳节", "1208 腊八节", "1224 小年",
			"0100*除夕"]
	var sFtv = ["0101*元旦", "0214 情人节", "0308 妇女节", "0312 植树节",
